...
obsluga_zegara PROC
	...
	;tylko co 18-sty znak będzie wypisywany
	add cs:pomiar_czasu, 1
	cmp cs:pomiar_czasu, 19 ;sprawdz czy = 19
	jb wypisywanie_pominiete
	
		;jesli rowne 19, wtedy zeruj zmienna "pomiar_czasu"
		mov cs:pomiar_czasu,0
		...
		; i kodu koloru: biały na czarnym tle (do następnego bajtu)
		 ...
		 mov byte PTR es:[bx+1], 01100001B ; kolor
